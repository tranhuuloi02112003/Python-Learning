...
> Tiếp theo bài 08. Bài này nói về khác biệt **kiến trúc tổ chức**, không phải cú pháp. (Auto-CRUD qua `ModelControllerBase` — 1 chủ đề riêng, không liên quan kiến trúc multi-instance — được tách sang bài `17-auto-crud-model-controller.md`.)
...
4 tính năng này (có sẵn trong Ninja/ninja-extra nhưng repo chưa dùng cái nào) được gộp riêng thành 1 bài — xem `15-list-features-va-throttling-chua-dung.md`.
