...
> Tiếp theo `12-error-handling-exception-toan-cuc.md`. 2 chủ đề trong bài này đều **chưa được dùng** trong `leadplusone_api` — viết ra để biết framework có gì, không nhầm lẫn khi gặp ở project khác hoặc khi cần dùng sau này.
