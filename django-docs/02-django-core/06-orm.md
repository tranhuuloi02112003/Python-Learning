# 06. Trái tim của hệ thống (Models & ORM)
...
- `Task.objects.get(id=5)`: Chỉ lấy ĐÚNG 1 cái có ID là 5 (không có thì báo lỗi - nhớ bài 03 Views không?).
...
**Tóm tắt bài 06:** Bạn không bao giờ phải động tay vào một dòng SQL nào cả. ORM của Django đã cung cấp cho bạn một cái điều khiển từ xa cực kỳ xịn để thao tác với Database và nối các bảng lại với nhau một cách diệu kỳ.
